...
for j in datasets:
    [model, MODEL] = LSTM_function(32,np.shape(train_X_data[0])[1], 1, 0.15, 60, 256, 0.2, early_stopping, j)
...
model, MODEL = LSTM_forecast(32, X_train.shape[1], 1, 0.15, 60, 256, 0.2)
