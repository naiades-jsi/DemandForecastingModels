...
[models.append(load_model('/home/costa/JoaoModelsForAlicante/Diputacion/models/DiputacionModel'+str(i)+'.h5')) for i in range(0,74)]
...
for i in range(0,len(train_performance)):
    ...
    path = "/home/costa/JoaoModelsForAlicante/Diputacion/DiputacionPerformance"
    plt.savefig(os.path.join(path, "DiputacionModelPerformance"+str(i)+".jpg"))
    plt.show()
...
for i in range(0,74):
    ...
    path = "/home/costa/JoaoModelsForAlicante/Diputacion/DiputacionTestPredictions"
    plt.savefig(os.path.join(path, "DiputacionTestPrediction"+str(i)+".jpg"))
    plt.show()
...
for i in range(0,74):
    ...
    path = "/home/costa/JoaoModelsForAlicante/Diputacion/DiputacionTrainPredictions"
    plt.savefig(os.path.join(path, "DiputacionTrainPrediction"+str(i)+".jpg"))
    plt.show()
...
for i in range(0, len(train_Y_data)):
    TrainErrors.append(mse(Y_train[i], pred_train[i][:,0]))
...
for i in range(0, len(test_Y_data)):
    TestErrors.append(mse(Y_test[i], pred_test[i][:,0]))
