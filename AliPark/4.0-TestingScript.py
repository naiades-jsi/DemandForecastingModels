...
for i in range(0,len(train_performance)):
    ...
    path = "/home/costa/JoaoModelsForAlicante/AliPark/AliParkPerformance"
    plt.savefig(os.path.join(path, "AliParkModelPerformance"+str(i)+".jpg"))
    plt.show()
...
for i in range(0 , len(train_Y_data)):
    ...
    path = "/home/costa/JoaoModelsForAlicante/AliPark/AliParkTrainPredictions"
    plt.savefig(os.path.join(path, "AliParkTrainPrediction"+str(i)+".jpg"))
    plt.show()
...
for i in range(0,len(test_Y_data)):
    ...
    path = "/home/costa/JoaoModelsForAlicante/AliPark/AliParkTestPredictions"
    plt.savefig(os.path.join(path, "AliParkTestPrediction"+str(i)+".jpg"))
    plt.show()
